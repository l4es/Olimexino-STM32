...
// nanovm/stm32/STM32
#define NATIVE_CLASS_STM32          (NATIVE_CLASS_BASE+5)
...
// nanovm/stm32/GPIO
#define NATIVE_CLASS_GPIO           (NATIVE_CLASS_BASE+6)
...
// nanovm/stm32/Uart (use PrintStream/InputStream for io)
...
// nanovm/olimexino
#define NATIVE_CLASS_OLIMEXINO      (NATIVE_CLASS_BASE+12)
